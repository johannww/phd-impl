...
// TODOHP: review this function generated by AI
func GenCompaniesWithPseudonyms(n int, mockIds *setup.MockIdentities) ([]*companies.Company, []*companies.PseudonymToCompanyID) {
